...
public class FieldUtils {
    ...
    public static void setCommonFieldByInsert(Object obj, String userCode) {
        Date date = new Date();
        setValue(obj, CREATOR, userCode);
        setValue(obj, CREATE_TIME, date);
        setValue(obj, UPDATER, userCode);
...
//            log.error("{} 中未找到属性 {},setter fail...", obj.getClass().getName(), fieldName, value);
            return;
        }
...
//            log.error("{} 中未找到属性 {},set fail...", obj.getClass().getName(), fieldName, value);
            return;
        }
        try {
            Field field = null;
