...
export default {
  ...
  methods: {
    initialData () {
      ...
      // this.title = '所属区域： ' + this.code + '大区';

      getRegionByCode(this.code).then(res => {
        const region = res.resData;
        this.title = '所属区域：' + region.name + '大区';
